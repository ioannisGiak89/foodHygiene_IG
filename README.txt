...
Demo: <http://138.68.81.23:8080/home>
...
Ensure you have all of the prerequisites listed above before starting
this.
...
After the image is build you'll just need to run it. The application is
...
(Note: if you're using Docker Machine, you'll need to also specify the
IP for the machine to connect. You can find out the IP address with
...
-   Improve cache. Add the time that the data cached, in order to avoid
    calling the api 2 times within few seconds
